...
//			});
  ...
  render() {
  	const {active:{wxs,chart_data,top,top_toals,zg},loading} = this.props;
      	...
      	<Card bordered={false}>
      		<Tabs defaultActiveKey="1" onChange={this.callback.bind(this)}>
				    <TabPane tab="列表" key="1">
			          ...
			          <Description term="参与人数">{top_toals != undefined ? top_toals.uNmber:''}</Description>
			          <Description term="BPCC发放">{top_toals !=undefined ? top_toals.total:''}</Description>
