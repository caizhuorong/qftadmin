...
const okHandle = () => {
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 6 }} wrapperCol={{ span: 15 }} label="奖励数量">
...
//			});
  ...
  render() {
  	const {active:{follow,chart_data,top,top_toal,zg},loading} = this.props;
      	...
      	<Card bordered={false}>
      		<Tabs defaultActiveKey="1" onChange={this.callback.bind(this)}>
				    <TabPane tab="列表" key="1">
			          ...
			          <Description term="参与人数">{top_toal != undefined ? top_toal.uNmber:''}</Description>
			          <Description term="BPCC发放">{top_toal != undefined ?top_toal.total:''}</Description>
